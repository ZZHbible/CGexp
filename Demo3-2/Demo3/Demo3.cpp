...
BEGIN_MESSAGE_MAP(CDemo3App, CWinAppEx)
...
// CDemo3App 自定义加载/保存方法

void CDemo3App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CDemo3App::LoadCustomState()
{
}

void CDemo3App::SaveCustomState()
{
}
...
//void CAboutDlg::OnMButtonUp(UINT nFlags, CPoint point)
//{
//	// TODO: 在此添加消息处理程序代码和/或调用默认值
//
